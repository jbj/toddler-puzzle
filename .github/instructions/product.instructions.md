...
to download and nothing to fail to load. The game is around 34 kB gzipped before
the first level appears and around 56 kB in total; `npm run build` fails if
