# 20260731T090000. A background belongs to the theme
...
child cannot place (see
[decision 20260729T101500](20260729T101500-every-piece-needs-something-in-it.md)).
That is precisely the opposite of what a backdrop wants, which is a busy horizon
and a quiet middle, because the middle is where the holes are. Scaled to a
1000x700 board it would also have to be stretched, and to a 700x1180 one
