...
posture is that it corrects imprecision without scolding
([20260727T072917](20260727T072917-generous-snap-radius.md)). Refusing a
placement that is visibly, exactly right teaches a two-year-old that the game
is arbitrary, which is worse than any amount of imprecision.
