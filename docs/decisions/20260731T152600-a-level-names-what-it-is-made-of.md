# 20260731T152600. A level names what it is made of
...
has one level where the swap the chapter is built on
([decision 20260729T090200](20260729T090200-two-shapes-the-same-are-the-same-piece.md))
never comes up; the test that used to require an interchangeable pair at every
polygon level now allows exactly one level without one, and no more.
