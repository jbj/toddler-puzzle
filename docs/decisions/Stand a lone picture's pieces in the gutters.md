# Stand a lone picture's pieces in the gutters
...
belongs. See [One box measures a piece, and one rule places
it](<One box measures a piece, and one rule places it.md>).
