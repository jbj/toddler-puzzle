...
Since [the board is composed for the screen it is
on](<The board is composed for the screen it is on.md>)
...
gutters](<Stand a lone picture's pieces in the gutters.md>);
...
target was a safety rail rather than a finding - that record names the
