# Generate layouts at stage start
...
counts, ground lines, tray rows and piece sizes to generate them into; [Compose
layouts for any cast, rather than tabulating
them](<Compose layouts for any cast, rather than tabulating them.md>) replaced
the tables with a composition that works for any piece count, and the rest of
