# Ask a touch level for a handful, and let the child out anyway
...
a child on by itself ([A celebration is played, and it ends by
itself](<A celebration is played, and it ends by itself.md>)).
...
The first chapter is quicker than it was, which is the intent ([Open the game
with something to touch](<Open the game with something to touch.md>)): the point
of the opening five is that a child reaches the end of them.
