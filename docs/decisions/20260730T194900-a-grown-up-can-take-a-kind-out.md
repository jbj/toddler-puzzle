# 20260730T194900. A grown-up can take a kind of puzzle out
...
[decision 20260727T072917](20260727T072917-no-menu-or-difficulty-picker.md)
...
stays the one declarative thing
[decision 20260728T205626](20260728T205626-declarative-level-table.md) says it
is.
...
grown-up can change
([decision 20260729T000652](20260729T000652-a-door-for-grown-ups.md)), which is
why this is not the difficulty picker the earlier decision rules out: a
two-year-old cannot reach it, cannot read it, and never sees that it happened.
...
was not bumped when `rotation` was dropped
([decision 20260730T203000](20260730T203000-no-rotation-mode.md)): every field is
read on its own, and a record written before the switches existed has no `kinds`
and reads as the whole ramp - the game it was written by.
...
([decision 20260729T223500](20260729T223500-a-chapter-is-warmed-before-it-is-needed.md)).
